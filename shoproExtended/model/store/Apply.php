...
class Apply extends Model
{
    ...
    public static function apply($params) {
        ...
        $data['phone'] = $phone;
        $data['province_name'] = $province ? $province->name : '';
        $data['city_name'] = $city ? $city->name : '';
        $data['area_name'] = $area ? $area->name : '';
        $data['province_id'] = $province ? $province->id : 0;
        $data['city_id'] = $city ? $city->id : 0;
        $data['area_id'] = $area ? $area->id : 0;
