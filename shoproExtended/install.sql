...
(1, 'shopro', 'basic', '商城信息', '', 'array', '{\"name\":\"Shopro\",\"domain\":\"https://m.shopro.top/\",\"version\":\"1.3.9\",\"logo\":\"http://file.shopro.top/uploads/20200410/d5b2c163e9a23d78c7205d9ab5d7e47c.png\",\"copyright\":[\"星品科技Shopro版权所有\",\"Copyright 2020-2022\"],\"user_protocol\":1,\"privacy_protocol\":2,\"about_us\":3}', NULL, '', ''),
...
CREATE TABLE `__PREFIX__shopro_commission_order`  (
  ...
  `commission_order_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '分销商业绩:-2=已取消,-1=已扣除,0=不计入,1=已计入',
  `commission_reward_status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '佣金处理状态:-2=已取消,-1=已退回,0=未结算,1=已结算',
...
CREATE TABLE `__PREFIX__shopro_commission_reward`  (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '状态:-2=已取消,-1=已退回,0=待入账,1=已入账',
  `createtime` int(10) NOT NULL COMMENT '创建时间',
  `updatetime` int(10) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
ALTER TABLE `__PREFIX__shopro_commission_reward` ADD INDEX `commission_order_id`(`commission_order_id`) USING BTREE;
ALTER TABLE `__PREFIX__shopro_commission_reward` ADD INDEX `agent_id`(`agent_id`) USING BTREE;
...
ALTER TABLE `__PREFIX__shopro_commission_order` ADD INDEX `order_id`(`order_id`) USING BTREE;
ALTER TABLE `__PREFIX__shopro_commission_order` ADD INDEX `order_item_id`(`order_item_id`) USING BTREE;
ALTER TABLE `__PREFIX__shopro_commission_order` ADD INDEX `buyer_id`(`buyer_id`) USING BTREE;
ALTER TABLE `__PREFIX__shopro_commission_order` ADD INDEX `goods_id`(`goods_id`) USING BTREE;
ALTER TABLE `__PREFIX__shopro_commission_order` ADD INDEX `agent_id`(`agent_id`) USING BTREE;
ALTER TABLE `__PREFIX__shopro_commission_order` ADD INDEX `createtime`(`createtime`) USING BTREE;

ALTER TABLE `__PREFIX__shopro_commission_reward` ADD INDEX `buyer_id`(`buyer_id`) USING BTREE;
